...
{{--        <img alt="Logo" src="assets/media/logos/logo-naga-1.png" width="60px"/>--}}

        <span class="mt-5 font-weight-bold font-size-h6">@lang('Quick cash')</span>
    </a>
    <!--end::Logo-->
    <!--begin::Toolbar-->
...
{{--                    <img alt="Logo" src="assets/media/logos/logo-naga-1.png" width="60px"/>--}}
                ...
                <p class="mt-4 font-weight-bold font-size-h6">@lang('Quick cash')</p>
                </a>
                <!--end::Logo-->
                <!--begin::Toggle-->
            ...
            <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
                ...
                <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
                    ...
                    <ul class="menu-nav">
                        ...
                        <li class="menu-item  @isset($list_sellers) menu-item-here @endisset" aria-haspopup="true">
                            <a href="{{route('seller.index')}}" class="menu-link">
                                <i class="menu-icon fas fa-user-secret"></i>
                                <span class="menu-text">@lang('Sellers')</span>
                            </a>
                        </li>
                        ...
                        <li class="menu-item  @isset($list_sells) menu-item-here @endisset" aria-haspopup="true">
                            <a href="{{route('sell.index')}}" class="menu-link">
                                ...
                                <span class="menu-text">@lang('Sell')</span>
                            </a>
                        </li>
            ...
            <div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
                ...
                <div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
                    ...
                    <div class="text-dark order-2 order-md-1">
                        ...
                        <a href="http://keenthemes.com/metronic" target="_blank" class="text-dark-75 text-hover-primary">New concept consulting</a>
                    </div>
                    <!--end::Copyright-->
                    <!--begin::Nav-->
